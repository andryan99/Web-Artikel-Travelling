...
$sl="select tbl_artikel.judul, tbl_artikel.waktu, tbl_artikel.isi, tbl_tulis_artikel.id_tulis, tbl_artikel.gambar, tbl_kontributor.nama, tbl_kategori.nama_kategori
...
$data_artikel=query($sl);	

$sql_judul_terbaru="select tbl_artikel.judul, tbl_artikel.waktu, tbl_artikel.isi, tbl_tulis_artikel.id_tulis, 
...
tbl_kontributor.id_kontributor=tbl_tulis_artikel.id_kontributor AND
tbl_kategori.id_kategori=tbl_tulis_artikel.id_kategori AND
tbl_kategori.nama_kategori = '$kategori' order by tbl_tulis_artikel.id_tulis desc";

$judul_terbaru=query($sql_judul_terbaru);
      
$sql="select tbl_artikel.judul, tbl_artikel.waktu, tbl_artikel.isi, tbl_tulis_artikel.id_tulis, 
tbl_artikel.gambar, tbl_kontributor.nama, tbl_kategori.nama_kategori
from tbl_artikel, tbl_kontributor, tbl_kategori, tbl_tulis_artikel
where tbl_artikel.id_artikel=tbl_tulis_artikel.id_artikel AND 
tbl_kontributor.id_kontributor=tbl_tulis_artikel.id_kontributor AND
...
switch ($kategori) {				
    case 'Alam':
        $sql = $sql . "tbl_kategori.nama_kategori = '$kategori'
        order by tbl_tulis_artikel.id_tulis desc";
        break;
...
<body>
	...
	<div class="container">
		...
		<div class="topnav clearfix">
			...
			<div class="main">			
				<?php 
				foreach ($kategori_terpilih as $item_artikel) : ?>
				<article class="card">			
			...
			<div class="sidebar">
				...
				<img src="aku.jpg" alt="gambar">

				<p>&nbsp;&nbsp; &nbsp; Saya Muhammad Andryan Mahasiswa Universitas Islam Negeri Maulana Malik Ibrahim Malang Fakultas Sains & Teknologi Jurusan Teknik Informatika&nbsp;&nbsp; &nbsp;</p>
				 --> 
			</div>
				...
				<div class="artikelterbaru">
					...
					<table>
					<?php 
				      foreach ($judul_terbaru as $item_artikel) : ?>
						<tr>	
